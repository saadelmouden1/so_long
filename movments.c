...
/*   Updated: 2024/04/08 02:50:04 by sel-moud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	move_0(game_cars *game, int i, int j)
{
	game->gamemap[j][i] = 'P';
	game->x_player = i;
	game->y_player = j;
...
int	move_u(game_cars *game, int i, int j, int c)
{
	j--;
...
int	move_d(game_cars *game, int i, int j, int c)
{
	j++;
	if (game->gamemap[j][i] == '1')
		return (0);
