...
/*   Updated: 2024/04/16 00:59:58 by sel-moud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	print_player(t_game_cars *game, int i, int j)
{
...
void	print_collect(t_game_cars *game, int i, int j)
{
	if (mlx_image_to_window(game->mlx, game->vd, j * 32, i * 32) < 0)
		ft_close(game);
...
void	print_exit(t_game_cars *game, int i, int j)
{
	if (mlx_image_to_window(game->mlx, game->vd, j * 32, i * 32) < 0)
		ft_close(game);
	if (mlx_image_to_window(game->mlx, game->exit, j * 32, i * 32) < 0)
...
void	print_borders(t_game_cars *game, int i, int j)
{
