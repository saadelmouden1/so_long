...
/*   Updated: 2024/04/16 01:57:49 by sel-moud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

int	is_move_valid(t_game_cars *game, int y, int x, int **has_visited)
{
...
void	flood_fill(t_game_cars *game, int y, int x, int **has_visited)
{
	int			i;
...
int	allocate(t_game_cars *game, int **has_visited)
{
	int	a;
	int	b;
...
void	free_int_tab(t_game_cars *game, int **has_visited)
{
	int	a;
